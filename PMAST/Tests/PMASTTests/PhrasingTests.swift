...
class PhrasingTests: XCTestCase {
    ...
    func testMid() throws {
        ...
        /// ~~DELETE~~
        document = StyledMarkdown("aSTRIKEa")
    ...
    func testEnclosing() throws {
        ...
        /// ~~DELETE~~
        document = StyledMarkdown("aS _SSS_ Sa")
        ...
        /// *EMPHASIS*
        document = StyledMarkdown("aS **SSS** Sa")
    ...
    func testPartial() throws {
        ...
        document = StyledMarkdown("_aaBB_ BBaa")
    ...
    func testEjectLeadingWhitespace() throws {
        ...
        document = StyledMarkdown("AAA BBB")
    ...
    func testUnwrap() throws {
        ...
        document = StyledMarkdown("aS _~~SSS~~_ Sa")
    ...
    func testExtensionLeading() throws {
        ...
        document = StyledMarkdown("~~AAA BBB~~ CCC")
